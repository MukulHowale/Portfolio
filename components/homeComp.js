let home = () =>{
    return `<div id="body_left">
    <div>Hello!</div>
    <div>I'm Mukul Howale</div>
    <div>I'm a BackEnd Developer</div>
    <p>
        I love working on backend systems
    ...
    <a href="https://github.com/MukulHowale">
        ...
        <a href="https://drive.google.com/file/d/10uqiSvL05ICqCHWpF7b0XYVkby3Dh54-/view?usp=sharing" style="text-decoration: none;">
            <span><div>RESUME</div></span>
        </a>
    </div>
</div>
<div id="body_right">
    <img src="../images/20211015_121240.jpg" alt="">
</div>`
}
